...
namespace TTNETAPI_Sample_Console_PriceDetailedDepthSubscription_EPIQ
{
    public class TTNetApiFunctions
    {
        ...
        private EstimatedPositionInQueueSubscription m_estimatedPositionInQueueSubscription = null;
        ...
        private void M_estimatedPositionInQueueSubscription_EstimatedPositionInQueueUpdated(object sender, EstimatedPositionInQueueEventArgs e)
        {
